    ...
    stages {
        stage('Paso 1: Clonar') {
            steps {
                ...
                curl -X POST -H "Content-Type: application/json" -d '{"chat_id": "881875692", "text": "Falló la tarea , ejecución , "}' https://api.telegram.org/bot6791917046:AAHuW0hZOl5D5raRyx1R11MWY7fIYHi66xQ/sendMessage
            }
        }
